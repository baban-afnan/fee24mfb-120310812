            ...
            <div class="card-body p-0">
                ...
                <div class="p-3 border-bottom bg-light">
                    <div class="row align-items-center g-3">
                         <div class="col-md-6">
                            <form method="GET" action="{{route('transactions.index')}}" class="input-group">
                        ...
                        <div class="col-md-6 text-md-end">
                            <div class="btn-group">
                                ...
                                @if(request()->anyFilled(['search', 'type', 'status', 'start_date', 'end_date']))
                                    <a href="{{ route('transactions.index') }}" class="btn btn-outline-danger" title="Clear All Filters">
                            ...
                            @forelse($transactions as $transaction)
                                <tr>
                                    ...
                                    <td class="text-end pe-4">
                                        <button class="btn btn-sm btn-primary border shadow-sm view-transaction-btn"
