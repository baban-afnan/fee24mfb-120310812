...
<x-slot name="title">NIN MOD - Control Form</x-slot>
        ...
        <div class="container-fluid">
            <div class="card shadow-sm rounded-lg mb-4 mt-4">
                <div class="card-body d-flex justify-content-between align-items-center p-4">
                    <div>
                        <h4 class="mb-1 font-weight-bold text-primary">NIN Modification Details</h4>
                        <p class="text-muted mb-0">View and manage NIN modification request</p>
                    </div>
                    <div>
                        <a href="{{ route('ninmod.index') }}" class="btn btn-outline-secondary fw-bold me-2 px-4">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const updateUrl = "{{ route('ninmod.update', $enrollmentInfo->id) }}";
