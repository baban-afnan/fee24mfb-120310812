            ...
            <div class="col-md-6 text-md-end">
                <div class="btn-group">
                    ...
                    @if(request('status') || request('search_bvn'))
                        <a href="{{ route('bvnsearch.index') }}" class="btn btn-outline-danger">
                ...
                <tbody>
                    @forelse ($enrollments as $enrollment)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('bvnsearch.show', $enrollment->id) }}" class="btn btn-sm btn-primary">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        let searchTimer;
        const searchInput = document.querySelector('input[name="search_phone_no"]');
        if (searchInput) {
